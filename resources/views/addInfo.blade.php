...
<title>Ajouter votre information</title>
...
<div class="card-body">
<h5 class="card-title">Ajouter votre information sur l'IA</h5>
...
<input name="titre" id="titre" placeholder="with a placeholder"  class="form-control">
</div>
</div>
</div>
<div class="form-row">
<div class="col-md-6">
<div class="position-relative form-group">
<label for="resume" class="">Type</label>
<input name="type" id="resume" placeholder="password placeholder" type="text" class="form-control" readonly value="Information sur l'IA">
...
<div class="col-md-6">
<div class="position-relative form-group">
<label for="sel" class="">Auteur</label>

<input name="resume" id="sel" placeholder="auteur" type="text" class="form-control">

</div>
</div>
</div>
<div class="position-relative form-group">
<label for="exampleAddress" class="">Résumé</label>
...
<div class="position-relative form-group">
<label for="exampleAddress" class="">Contenus</label>
...
<div class="col-md-6">
<div class="position-relative form-group">
<label for="exampleCity" class="">Création</label>
<input name="creation" id="exampleCity" type="date" class="form-control">
</div>
</div>
<div class="col-md-4">
<div class="position-relative form-group">
<label for="exampleState" class="">Publication</label>
<input name="publication" id="exampleState" type="date" class="form-control">
</div>
</div>
...
<button class="mt-2 btn btn-primary">Ajouter votre information</button>
</form>
</div>
</div>
<script>
