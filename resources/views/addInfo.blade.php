...
<div class="col-md-6">
<div class="position-relative form-group">
<label for="resume" class="">Résumé</label>
<input name="resume" id="resume" placeholder="password placeholder" type="text" class="form-control">
...
<select name="" id="sel" class="form-select" name="idauteur">
  <option value="1">JJRabearivelo</option>
